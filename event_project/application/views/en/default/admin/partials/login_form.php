      ...
      <div id="login" class="animate form">
        <section class="login_content">
          <form method="post" action="<?php echo site_url('admin'); ?>">
            <h1>Login Form</h1>
            <div class="error" style='font-weight:bold;color:red;'><?php if($this->session->flashdata('error')){echo $this->session->flashdata('error');} ?></div>
            <div>
            ...
            <div>
              ...
              <a class="reset_pass hidden" href="#">Lost your password?</a>
            </div>
