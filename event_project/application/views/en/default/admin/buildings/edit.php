	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<form class="form-horizontal form-label-left" method="post" action="<?php echo site_url('admin/buildings/edit'); ?>">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="" required="required" type="text" value="<?php echo $rec->name; ?>">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="longitude" name="longitude" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $rec->longitude; ?>">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" id="latitude" name="latitude" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $rec->latitude; ?>">
